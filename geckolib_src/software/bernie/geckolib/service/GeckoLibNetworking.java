...
public interface GeckoLibNetworking {
     ...
     */
    default <D> void syncSingletonAnimData(SingletonGeoAnimatable animatable, long instanceId, SerializableDataTicket<D> dataTicket, D data, class_1297 entityToTrack) {
     ...
     */
    default void triggerBlockEntityAnim(class_2338 pos, class_3218 level, @Nullable String controllerName, String animName) {
    ...
    default void triggerEntityAnim(class_1297 entity, boolean isReplacedEntity, @Nullable String controllerName, String animName) {
        sendToAllPlayersTrackingEntity(new EntityAnimTriggerPacket(entity.method_5628(), isReplacedEntity, Optional.ofNullable(controllerName), animName), entity);
    }

    /**
     * {@link software.bernie.geckolib.animatable.SingletonGeoAnimatable#triggerAnim(class_1297, long, String, String) Trigger}
     * an animation for the given {@link software.bernie.geckolib.animatable.SingletonGeoAnimatable SingletonGeoAnimatable}
     */
    default void triggerSingletonAnim(SingletonGeoAnimatable animatable, class_1297 entityToTrack, long instanceId, @Nullable String controllerName, String animName) {
     ...
     */
    default void stopTriggeredBlockEntityAnim(class_2338 pos, class_3218 level, @Nullable String controllerName, @Nullable String animName) {
     ...
     */
    default void stopTriggeredEntityAnim(class_1297 entity, boolean isReplacedEntity, @Nullable String controllerName, @Nullable String animName) {
        sendToAllPlayersTrackingEntity(new StopTriggeredEntityAnimPacket(entity.method_5628(), isReplacedEntity, Optional.ofNullable(controllerName), Optional.ofNullable(animName)), entity);
    }

    /**
     * {@link software.bernie.geckolib.animatable.SingletonGeoAnimatable#stopTriggeredAnim(class_1297, long, String, String) Stop}
     ...
     */
    default void stopTriggeredSingletonAnim(SingletonGeoAnimatable animatable, class_1297 entityToTrack, long instanceId, @Nullable String controllerName, @Nullable String animName) {
