...
public abstract class GeoModel<T extends GeoAnimatable> {
	 ...
	 */
	public abstract class_2960 getModelResource(GeoRenderState renderState);

	/**
	 * Returns the resource path for the texture file to render based on the provided {@link GeoRenderState}
	 */
	public abstract class_2960 getTextureResource(GeoRenderState renderState);
	...
	public @Nullable Animation getBakedAnimation(T animatable, String name) throws RuntimeException {
        final class_2960 animationFile = getAnimationResource(animatable);
        final class_2960[] fallbackFiles = getAnimationResourceFallbacks(animatable);
