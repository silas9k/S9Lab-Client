...
public record GeometryDefinition(@Nullable GeometryDescription description, @Nullable String cape, GeometryBone @Nullable [] bones) {
    ...
    public static JsonDeserializer<GeometryDefinition> gsonDeserializer() throws JsonParseException {
        return (json, type, context) -> {
            ...
            final GeometryDescription description = class_3518.method_15283(obj, "description", null, context, GeometryDescription.class);
            final String cape = class_3518.method_15253(obj, "cape", null);
            final GeometryBone[] bones = JsonUtil.jsonArrayToObjectArray(class_3518.method_15292(obj, "bones", new JsonArray(0)), context, GeometryBone.class);
