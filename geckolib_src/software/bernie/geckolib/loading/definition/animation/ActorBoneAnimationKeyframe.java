    ...
    public static JsonDeserializer<ActorBoneAnimationKeyframe> gsonDeserializer() throws JsonParseException {
        return (json, type, context) -> {
            if (json.isJsonObject()) {
                ...
                final ActorBoneAnimationKeyframeValues values = class_3518.method_15283(obj, "vector", null, context, ActorBoneAnimationKeyframeValues.class);
                ...
                final DoubleOrString[] easingArgs = JsonUtil.jsonArrayToObjectArray(class_3518.method_15292(obj, "easingArgs", null), context, DoubleOrString.class);
                final ActorBoneAnimationKeyframe preKeyframe = class_3518.method_15283(obj, "pre", null, context, ActorBoneAnimationKeyframe.class);
                final ActorBoneAnimationKeyframe postKeyframe = class_3518.method_15283(obj, "post", null, context, ActorBoneAnimationKeyframe.class);
