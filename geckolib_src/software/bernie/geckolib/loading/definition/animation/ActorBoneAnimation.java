...
public record ActorBoneAnimation(@Nullable String relativeTo,
    ...
    public static JsonDeserializer<ActorBoneAnimation> gsonDeserializer() throws JsonParseException {
        return (json, type, context) -> {
            ...
            final String relativeTo = class_3518.method_15253(obj, "relative_to", null);
            final ActorBoneAnimationEntry positionKeyframes = class_3518.method_15283(obj, "position", null, context, ActorBoneAnimationEntry.class);
            final ActorBoneAnimationEntry rotationKeyframes = class_3518.method_15283(obj, "rotation", null, context, ActorBoneAnimationEntry.class);
            final ActorBoneAnimationEntry scaleKeyframes = class_3518.method_15283(obj, "scale", null, context, ActorBoneAnimationEntry.class);
