...
public record ActorAnimation(@Nullable Float animLength, @Nullable Either<Boolean, String> loop, @Nullable String startDelay, @Nullable String loopDelay, @Nullable String animTimeUpdate,
    ...
    public static JsonDeserializer<ActorAnimation> gsonDeserializer() throws JsonParseException {
        return (json, type, context) -> {
            ...
            final String startDelay = class_3518.method_15253(obj, "start_delay", null);
            final String loopDelay = class_3518.method_15253(obj, "loop_delay", null);
            final String animTimeUpdate = class_3518.method_15253(obj, "anim_time_update", null);
            final String blendWeight = class_3518.method_15253(obj, "blend_weight", null);
            final Boolean overridePrevAnimation = JsonUtil.getOptionalBoolean(obj, "override_previous_animation");
            final Map<String, ActorBoneAnimation> boneAnimations = JsonUtil.jsonObjToMap(class_3518.method_15281(obj, "bones", null), context, ActorBoneAnimation.class);
            final Map<String, ActorAnimationParticleEffect> particleEffects = JsonUtil.jsonObjToMap(class_3518.method_15281(obj, "particle_effects", null), context, ActorAnimationParticleEffect.class);
            final Map<String, ActorAnimationSoundEffect> soundEffects = JsonUtil.jsonObjToMap(class_3518.method_15281(obj, "sound_effects", null), context, ActorAnimationSoundEffect.class);
            final Map<String, String> timeline = JsonUtil.jsonObjToPrimitiveMap(class_3518.method_15281(obj, "timeline", null), context, JsonElement::getAsString);
