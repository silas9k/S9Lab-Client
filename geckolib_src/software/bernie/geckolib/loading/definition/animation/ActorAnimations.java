...
public record ActorAnimations(String formatVersion, Map<String, ActorAnimation> animations) {
    ...
    public static JsonDeserializer<ActorAnimations> gsonDeserializer() throws JsonParseException {
        return (json, type, context) -> {
            ...
            final String formatVersion = class_3518.method_15265(obj, "format_version");
            final Map<String, ActorAnimation> animations = JsonUtil.jsonObjToMap(class_3518.method_15296(obj, "animations"), context, ActorAnimation.class);
