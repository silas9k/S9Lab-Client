...
public record Bone(Cube[] cubes, @Nullable Boolean debug,
	...
	public static JsonDeserializer<Bone> deserializer() throws JsonParseException {
		return (json, type, context) -> {
			...
			Cube[] cubes = JsonUtil.jsonArrayToObjectArray(class_3518.method_15292(obj, "cubes", null), context, Cube.class);
			...
			String name = class_3518.method_15265(obj, "name");
			...
			TextureMesh[] textureMeshes = JsonUtil.jsonArrayToObjectArray(class_3518.method_15292(obj, "texture_meshes", null), context, TextureMesh.class);
