...
public interface SingletonGeoAnimatable extends GeoAnimatable {
     ...
     */
    @ApiStatus.NonExtendable
    default <D> void setAnimData(class_1297 relatedEntity, long instanceId, SerializableDataTicket<D> dataTicket, D data) {
     ...
     */
    @ApiStatus.NonExtendable
    default <D> void syncAnimData(long instanceId, SerializableDataTicket<D> dataTicket, D data, class_1297 entityToTrack) {
     ...
     */
    @ApiStatus.NonExtendable
    default void triggerAnim(class_1297 relatedEntity, long instanceId, @Nullable String controllerName, String animName) {
        if (relatedEntity.method_73183().method_8608()) {
     ...
     */
    @ApiStatus.NonExtendable
    default void stopTriggeredAnim(class_1297 relatedEntity, long instanceId, @Nullable String controllerName, @Nullable String animName) {
        if (relatedEntity.method_73183().method_8608()) {
            AnimatableManager<GeoAnimatable> animatableManager = getAnimatableInstanceCache().getManagerForId(instanceId);
     ...
     */
    @ApiStatus.NonExtendable
    default void triggerArmorAnim(class_1297 relatedEntity, long instanceId, @Nullable String controllerName, String animName) {
     ...
     */
    @ApiStatus.NonExtendable
    default void stopTriggeredArmorAnim(class_1297 relatedEntity, long instanceId, @Nullable String controllerName, @Nullable String animName) {
