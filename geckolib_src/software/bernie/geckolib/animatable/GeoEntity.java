...
public interface GeoEntity extends GeoAnimatable {
	...
	default <D> @Nullable D getAnimData(SerializableDataTicket<D> dataTicket) {
		return getAnimatableInstanceCache().getManagerForId(((class_1297)this).method_5628()).getAnimatableData(dataTicket);
	}
	...
	default <D> void setAnimData(SerializableDataTicket<D> dataTicket, D data) {
		...
		if (entity.method_73183().method_8608()) {
			getAnimatableInstanceCache().getManagerForId(entity.method_5628()).setAnimatableData(dataTicket, data);
		}
		else {
	...
	default void triggerAnim(@Nullable String controllerName, String animName) {
		...
		if (entity.method_73183().method_8608()) {
			AnimatableManager<GeoAnimatable> animatableManager = getAnimatableInstanceCache().getManagerForId(entity.method_5628());
