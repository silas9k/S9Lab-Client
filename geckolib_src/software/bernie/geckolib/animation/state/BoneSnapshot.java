...
public class BoneSnapshot {
     ...
     */
    public void scale(class_4587 poseStack) {
        if (hasScale())
            poseStack.method_22905(getScaleX(), getScaleY(), getScaleZ());
    }
    ...
    public void rotate(class_4587 poseStack) {
        if (getRotZ() != 0)
            poseStack.method_22907(class_7833.field_40718.rotation(getRotZ()));

        if (getRotY() != 0)
            poseStack.method_22907(class_7833.field_40716.rotation(getRotY()));

        if (getRotX() != 0)
            poseStack.method_22907(class_7833.field_40714.rotation(getRotX()));
    }

    /**
     * Apply a translation to the provided PoseStack by this snapshot's position offset
     */
    public void translate(class_4587 poseStack) {
        if (hasTranslation())
            poseStack.method_46416(-getTranslateX() / 16f, getTranslateY() / 16f, getTranslateZ() / 16f);
    }
