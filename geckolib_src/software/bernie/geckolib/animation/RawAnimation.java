...
public final class RawAnimation {
    public static final class_9139<ByteBuf, RawAnimation> STREAM_CODEC = class_9139.method_56434(
            Stage.STREAM_CODEC.method_56433(class_9135.method_56363()), instance -> instance.animationList,
            RawAnimation::new);
	...
	public record Stage(String animationName, LoopType loopType, int waitTicks) {
        public static final class_9139<ByteBuf, Stage> STREAM_CODEC = class_9139.method_56436(
                class_9135.field_48554, Stage::animationName,
                class_9135.field_48554.method_56432(LoopType::fromString, LoopType::getId), Stage::loopType,
                class_9135.field_48550, Stage::waitTicks,
                Stage::new);
