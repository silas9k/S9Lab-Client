...
public final class DefaultAnimations {
	 ...
	 * <p>
	 * Plays an attack animation if the animatable is {@link net.minecraft.class_1309#field_6252}
	 * <p>
	 ...
	 */
	public static <T extends class_1309 & GeoAnimatable> AnimationController<T> genericAttackAnimation(RawAnimation attackAnimation) {
	...
	public static <T extends GeoAnimatable> AnimationController<T> genericWalkFlyIdleController(class_1308 entity) {
        return new AnimationController<>("Walk/Fly/Idle", 0, state -> {
            if (entity.method_24828() || (!entity.method_5987() && entity.method_23314().method_10264() + 1 == entity.method_23318()))
	 ...
	 * <p>
	 * If the entity is considered moving, will either walk or run depending on the {@link class_1297#method_5624()} method, otherwise it will idle
	 */
    ...
    public static <R extends GeoRenderState> void hardcodedHeadRotation(RenderPassInfo<R> renderPassInfo, BoneSnapshots snapshots, String headBone) {
        snapshots.get(headBone).ifPresent(bone -> {
            ...
            bone.setRotX(-pitch * class_3532.field_29847);
            bone.setRotY(-yaw * class_3532.field_29847);
        });
    }
}
