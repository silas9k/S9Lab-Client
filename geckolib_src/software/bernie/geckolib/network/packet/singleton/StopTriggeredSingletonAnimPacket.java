...
public record StopTriggeredSingletonAnimPacket(String syncableId, long instanceId, Optional<String> controllerName, Optional<String> animName) implements MultiloaderPacket {
    public static final class_9154<StopTriggeredSingletonAnimPacket> TYPE = new class_9154<>(GeckoLibConstants.id("stop_triggered_singleton_anim"));
    public static final class_9139<class_2540, StopTriggeredSingletonAnimPacket> CODEC = class_9139.method_56905(
            class_9135.field_48554, StopTriggeredSingletonAnimPacket::syncableId,
            class_9135.field_48551, StopTriggeredSingletonAnimPacket::instanceId,
            class_9135.field_48554.method_56433(class_9135::method_56382), StopTriggeredSingletonAnimPacket::controllerName,
            class_9135.field_48554.method_56433(class_9135::method_56382), StopTriggeredSingletonAnimPacket::animName,
