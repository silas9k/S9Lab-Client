 ...
 */
public class CompileEntityRenderStateEvent<T extends class_1297 & GeoAnimatable, R extends class_10017 & GeoRenderState> implements GeoRenderEvent.Entity.CompileRenderState<T, R> {
    ...
    /**
     * Event listener interface for the {@link class_1297.CompileRenderState} GeoRenderEvent
     *
     * @param <T> Entity animatable class type
     * @param <R> RenderState class type
     */
