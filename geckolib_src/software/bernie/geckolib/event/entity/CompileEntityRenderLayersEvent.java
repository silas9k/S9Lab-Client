 ...
 */
public class CompileEntityRenderLayersEvent<T extends class_1297 & GeoAnimatable, R extends class_10017 & GeoRenderState> implements GeoRenderEvent.Entity.CompileRenderLayers<T, R> {
    ...
    /**
     * Event listener interface for the {@link class_1297.CompileRenderLayers} GeoRenderEvent
     *
     * @param <T> Entity animatable class type
     * @param <R> RenderState class type
     */
