 ...
 */
public class CompileItemRenderStateEvent<T extends class_1792 & GeoAnimatable> implements GeoRenderEvent.Item.CompileRenderState<T> {
    ...
    /**
     * Event listener interface for the {@link class_1792.CompileRenderState} GeoRenderEvent
     *
     * @param <T> Item animatable class type
     */
    @FunctionalInterface
