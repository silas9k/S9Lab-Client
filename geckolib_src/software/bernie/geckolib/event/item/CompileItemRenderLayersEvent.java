 ...
 */
public class CompileItemRenderLayersEvent<T extends class_1792 & GeoAnimatable> implements GeoRenderEvent.Item.CompileRenderLayers<T> {
    ...
    /**
     * Event listener interface for the {@link class_1792.CompileRenderLayers} GeoRenderEvent
     *
     * @param <T> Item animatable class type
     */
    @FunctionalInterface
