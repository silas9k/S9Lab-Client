 ...
 */
public class CompileReplacedEntityRenderStateEvent<T extends GeoAnimatable, E extends class_1297, R extends class_10017 & GeoRenderState> implements GeoRenderEvent.ReplacedEntity.CompileRenderState<T, E, R> {
    ...
    @Override
    public net.minecraft.class_1297 getReplacedEntity() {
        return this.entity;
    }
