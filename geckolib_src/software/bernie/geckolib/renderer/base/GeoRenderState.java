...
public interface GeoRenderState {
    ...
    default int getPackedLight() {
        return getOrDefaultGeckolibData(DataTickets.PACKED_LIGHT, class_765.field_32767);
    }
    ...
    default float getPartialTick() {
        return getOrDefaultGeckolibData(DataTickets.PARTIAL_TICK, class_310.method_1551().method_61966().method_60637(false));
    }
