...
public sealed interface GeoRendererInternals<T extends GeoAnimatable, O, R extends GeoRenderState> permits GeoRenderer {
     ...
     */
    default class_2960 getTextureLocation(R renderState) {
     ...
     */
    default void preApplyRenderLayers(RenderPassInfo<R> renderPassInfo, class_11659 renderTasks) {
        for (GeoRenderLayer<T, O, R> renderLayer : getRenderLayers()) {
     ...
     */
    default void applyRenderLayers(RenderPassInfo<R> renderPassInfo, class_11659 renderTasks) {
        for (GeoRenderLayer<T, O, R> renderLayer : getRenderLayers()) {
     ...
     */
    default void submitPerBoneRenderTasks(RenderPassInfo<R> renderPassInfo, class_11659 renderTasks) {
        ...
        renderPassInfo.renderPosed(() -> {
            ...
            poseStack.method_23760().method_23761().set(pose);
     ...
     */
    boolean firePreRenderEvent(RenderPassInfo<R> renderPassInfo, class_11659 renderTasks);
}
