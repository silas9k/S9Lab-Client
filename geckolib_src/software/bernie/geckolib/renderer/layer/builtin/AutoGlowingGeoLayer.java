...
public class AutoGlowingGeoLayer<T extends GeoAnimatable, O, R extends GeoRenderState> extends TextureLayerGeoLayer<T, O, R> {
	...
	protected static final RenderPipeline RENDER_PIPELINE = class_10799.method_67887(EmissiveRenderType.createRenderPipeline());
	...
	protected int getBrightness(R renderState) {
		return class_765.field_32768;
	}

	/**
	 * Get the render type to use for this glowmask renderer, or null if the layer should not render
	 * <p>
	 * Uses a custom RenderType similar to {@link class_12249#method_76014(class_2960)} by default
	 * <p>
	...
	protected @Nullable class_1921 getRenderType(R renderState) {
		...
		if (entityRenderState.method_72997()) {
			if (invisible)
				return class_12249.method_76018(texture);
	...
	public static class EmissiveRenderType {
		private static final Map<Entry, class_1921> CACHE = new ConcurrentHashMap<>();
		...
		private static RenderPipeline createRenderPipeline() {
			return RenderPipeline.builder(class_10799.field_60128)
		...
		/**
		 * Create GeckoLib's custom {@link class_1921} for emissive rendering since {@code EYES} isn't quite right
		 */
		private static class_1921 buildNewInstance(Entry entry) {
			final class_12247.class_12248 builder = class_12247.method_75927(RENDER_PIPELINE)
					.method_75934("Sampler0", entry.texture)
					.method_75930(entry.zOffset ? class_12245.field_63976 : class_12245.field_63975)
					.method_75932(entry.outline ? class_12247.class_4750.field_21855 : class_12247.class_4750.field_21853)
					.method_75937();

			if (entry.respectLighting) {
				return class_1921.method_75940(GeckoLibConstants.MODID + "_entity_translucent_emissive", builder
						.method_75935()
						.method_75936()
						.method_75938());
			}

			return class_1921.method_75940(GeckoLibConstants.MODID + "_emissive", builder
					.method_75938());
		}
