...
public abstract class DyeableGeoArmorRenderer<T extends class_1792 & GeoItem, R extends class_10034 & GeoRenderState> extends GeoArmorRenderer<T, R> {
    ...
    public void preRenderPass(RenderPassInfo<R> renderPassInfo, class_11659 renderTasks) {
        ...
        for (GeoBone bone : this.dyeableBones) {
            renderPassInfo.addPerBoneRender(bone, (renderPassInfo1, bone1, renderTasks1) -> {
                ...
                if (renderType != null) {
                    renderTasks1.method_73483(renderPassInfo1.poseStack(), renderType, (pose, vertexConsumer) ->
    ...
    protected void renderDyedBone(R renderState, class_4587.class_4665 pose, GeoBone bone1, RenderPassInfo<R> renderPassInfo1, class_4588 vertexConsumer, int renderColor) {
        ...
        bone1.render(renderPassInfo1, new class_4587(), vertexConsumer, renderPassInfo1.packedLight(), renderPassInfo1.packedOverlay(),
                     class_9848.method_61322(renderColor, getColorForBone(renderState, bone1, renderState.getOrDefaultGeckolibData(DataTickets.RENDER_COLOR, -1))));
    }
