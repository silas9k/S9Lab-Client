...
public final class CosmeticPreviewRenderer {
    ...
    public static void draw(
        ...
        if (tryOn && cosmetic != null) {
            ...
            if (cosmetic.type() == CosmeticType.CAPE) {
                applyPreviewCape(state, cosmetic);
            } else {
                removeCape(state);
            }
        }
    ...
    private static void applyPreviewCape(PlayerEntityRenderState state, Cosmetic cosmetic) {
        SkinTextures original = state.skinTextures;
        if (original == null || cosmetic.texture() == null) {
        ...
        AssetInfo.TextureAsset capeAsset = new AssetInfo.TextureAsset() {
            ...
            @Override
            public net.minecraft.util.Identifier texturePath() {
                return cosmetic.texture();
            }
        };
