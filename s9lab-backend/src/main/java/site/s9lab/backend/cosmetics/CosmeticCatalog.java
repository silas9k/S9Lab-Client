...
public final class CosmeticCatalog {
    ...
    public static List<CosmeticDefinition> defaults() {
        return List.of(
                cosmetic("s9lab_cape", "cape", "S9Lab Cape", "Classic S9Lab cape.", 150, "RARE"),
                cosmetic("s9lab_flux_cape", "cape", "Flux Cape", "Animated electric cape.", 350, "EPIC"),
                cosmetic("s9lab_void_cape", "cape", "Void Cape", "Dark clean cape.", 250, "RARE"),
                cosmetic("s9lab_redstone_cape", "cape", "Redstone Cape", "Animated redstone cape.", 300, "EPIC"),
                ...
                cosmetic("s9lab_dragon_wings", "wings", "Dragon Wings", "Scaled ender dragon style wings.", 700, "LEGENDARY"),
                cosmetic("s9lab_color_dragon_wings", "wings", "Color Dragon Wings", "Configurable dragon wings.", 900, "LEGENDARY"),
                cosmetic("s9lab_blue_energy_wings", "wings", "Blue Energy Wings", "Premium cyan-blue energy wings with a soft pulse.", 950, "LEGENDARY"),
                ...
                cosmetic("s9lab_rainbow_glint", "glint", "Rainbow Glint", "Animated rainbow body glint.", 450, "EPIC"),
    ...
    private static CosmeticDefinition cosmetic(String id, String type, String name, String description, long price, String rarity) {
        return new CosmeticDefinition(id, type, name, description, price, true, rarity, false, 0L, 0L, false, "", "");
    }
}
